  ...
  // ===== UNIT 1: BASICS =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '👫🏙️',
        lines: [
          { speaker: 'Marie', french: 'Bonjour! Comment allez-vous?', english: 'Hello! How are you?' },
          { speaker: 'Pierre', french: 'Bonsoir! Je vais bien, merci.', english: 'Good evening! I am doing well, thank you.' },
          { speaker: 'Marie', french: 'Bonne nuit!', english: 'Good night!' },
          { speaker: 'Pierre', french: 'Au revoir!', english: 'Goodbye!' },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🏪🛒',
        lines: [
          { speaker: 'Client', french: "Excusez-moi, s'il vous plaît.", english: 'Excuse me, please.' },
          { speaker: 'Vendeur', french: 'Oui? Je peux vous aider?', english: 'Yes? Can I help you?' },
          { speaker: 'Client', french: 'Merci beaucoup!', english: 'Thank you very much!' },
          { speaker: 'Vendeur', french: 'De rien!', english: "You're welcome!" },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🤝🎉',
        lines: [
          { speaker: 'Sophie', french: 'Bonjour! Je m\'appelle Sophie.', english: 'Hello! My name is Sophie.' },
          { speaker: 'Luc', french: 'Enchanté! Je m\'appelle Luc.', english: 'Nice to meet you! My name is Luc.' },
          { speaker: 'Sophie', french: 'Je suis française. Et vous?', english: 'I am French. And you?' },
          { speaker: 'Luc', french: 'Je suis américain. Je parle un peu français.', english: 'I am American. I speak a little French.' },
        ],
  ...
  // ===== UNIT 2: PEOPLE =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '👨‍👩‍👧‍👦🏠',
        lines: [
          { speaker: 'Emma', french: 'Voici ma famille!', english: 'Here is my family!' },
          { speaker: 'Emma', french: 'Mon père s\'appelle Jean.', english: 'My father\'s name is Jean.' },
          { speaker: 'Emma', french: 'Ma mère s\'appelle Claire.', english: 'My mother\'s name is Claire.' },
          { speaker: 'Emma', french: 'Et mon frère s\'appelle Hugo.', english: 'And my brother\'s name is Hugo.' },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '👦👧🏫',
        lines: [
          { speaker: 'Julie', french: 'Regarde! C\'est mon ami Thomas.', english: 'Look! That\'s my friend Thomas.' },
          { speaker: 'Marc', french: 'Il est grand?', english: 'Is he tall?' },
          { speaker: 'Julie', french: 'Oui, il est grand et jeune.', english: 'Yes, he is tall and young.' },
          { speaker: 'Marc', french: 'Et il est gentil?', english: 'And is he kind?' },
          { speaker: 'Julie', french: 'Oui, très gentil!', english: 'Yes, very kind!' },
        ],
  ...
  // ===== UNIT 3: FOOD & DRINK =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🧑‍🍳🍽️',
        lines: [
          { speaker: 'Maman', french: 'Tu as faim?', english: 'Are you hungry?' },
          { speaker: 'Léo', french: 'Oui! J\'ai très faim!', english: 'Yes! I am very hungry!' },
          { speaker: 'Maman', french: 'Je mange du pain et du fromage.', english: 'I am eating bread and cheese.' },
          { speaker: 'Léo', french: 'Et moi, je voudrais une pomme.', english: 'And me, I would like an apple.' },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '☕🧑‍🤝‍🧑',
        lines: [
          { speaker: 'Serveur', french: 'Bonjour! Qu\'est-ce que vous voulez boire?', english: 'Hello! What would you like to drink?' },
          { speaker: 'Anna', french: 'Un café, s\'il vous plaît.', english: 'A coffee, please.' },
          { speaker: 'Serveur', french: 'Et pour vous?', english: 'And for you?' },
          { speaker: 'Paul', french: 'Un thé, s\'il vous plaît. J\'ai soif!', english: 'A tea, please. I am thirsty!' },
        ],
  ...
  // ===== UNIT 4: TRAVEL =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🗺️🧳',
        lines: [
          { speaker: 'Touriste', french: 'Excusez-moi, où est la gare?', english: 'Excuse me, where is the train station?' },
          { speaker: 'Passant', french: 'Allez tout droit, puis à gauche.', english: 'Go straight ahead, then to the left.' },
          { speaker: 'Touriste', french: 'Merci beaucoup!', english: 'Thank you very much!' },
          { speaker: 'Passant', french: 'De rien! C\'est à cinq minutes.', english: "You're welcome! It's five minutes away." },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🍽️👨‍🍳',
        lines: [
          { speaker: 'Client', french: 'Une table pour deux, s\'il vous plaît.', english: 'A table for two, please.' },
          { speaker: 'Serveur', french: 'Bien sûr! Voici le menu.', english: 'Of course! Here is the menu.' },
          { speaker: 'Client', french: 'Je voudrais le poulet, s\'il vous plaît.', english: 'I would like the chicken, please.' },
          { speaker: 'Serveur', french: 'Très bien. Bon appétit!', english: 'Very well. Enjoy your meal!' },
          { speaker: 'Client', french: 'L\'addition, s\'il vous plaît.', english: 'The bill, please.' },
        ],
  ...
  // ===== UNIT 5: NUMBERS & TIME =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🛍️💰',
        lines: [
          { speaker: 'Client', french: 'C\'est combien?', english: 'How much is it?' },
          { speaker: 'Vendeur', french: 'C\'est quinze euros.', english: 'It\'s fifteen euros.' },
          { speaker: 'Client', french: 'Voici vingt euros.', english: 'Here is twenty euros.' },
          { speaker: 'Vendeur', french: 'Et cinq euros pour vous. Merci!', english: 'And five euros for you. Thank you!' },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '📅🗓️',
        lines: [
          { speaker: 'Alice', french: 'Quel jour sommes-nous?', english: 'What day is it?' },
          { speaker: 'Tom', french: 'Aujourd\'hui, c\'est mercredi.', english: 'Today is Wednesday.' },
          { speaker: 'Alice', french: 'Et demain?', english: 'And tomorrow?' },
          { speaker: 'Tom', french: 'Demain, c\'est jeudi!', english: 'Tomorrow is Thursday!' },
        ],
  ...
  // ===== UNIT 6: VERBS =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🏃‍♂️🌅',
        lines: [
          { speaker: 'Claire', french: 'Qu\'est-ce que tu fais le matin?', english: 'What do you do in the morning?' },
          { speaker: 'David', french: 'Je mange et je bois du café.', english: 'I eat and I drink coffee.' },
          { speaker: 'Claire', french: 'Et après?', english: 'And after?' },
          { speaker: 'David', french: 'Je vais au travail. Je parle français!', english: 'I go to work. I speak French!' },
        ],
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🏫📝',
        lines: [
          { speaker: 'Prof', french: 'Tu es étudiant?', english: 'Are you a student?' },
          { speaker: 'Élève', french: 'Oui, je suis étudiant.', english: 'Yes, I am a student.' },
          { speaker: 'Prof', french: 'Tu as un livre?', english: 'Do you have a book?' },
          { speaker: 'Élève', french: 'Oui, j\'ai un livre et un stylo.', english: 'Yes, I have a book and a pen.' },
        ],
  ...
  // ===== UNIT 7: COLORS & CLOTHES =====
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        picture: '🎨👗',
        lines: [
          { speaker: 'Camille', french: 'Quelle est ta couleur préférée?', english: 'What is your favorite color?' },
          { speaker: 'Nina', french: 'J\'aime le bleu et le vert!', english: 'I like blue and green!' },
          { speaker: 'Camille', french: 'Moi, j\'aime le rouge.', english: 'Me, I like red.' },
          { speaker: 'Nina', french: 'Ta robe est blanche et rose. C\'est joli!', english: 'Your dress is white and pink. It\'s pretty!' },
        ],
        question: 'What are Nina\'s favorite colors?',
